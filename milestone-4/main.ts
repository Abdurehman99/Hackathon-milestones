    ...
    function updateResume() {
        ...
        let resumeHTML = `
            <div class="resume-section">
                ...
                <ul>
                    <li><strong>Name:</strong> <span class="editable" contenteditable="true">${name}</span></li>
                    <li><strong>Email:</strong> <span class="editable" contenteditable="true">${email}</span></li>
                    <li><strong>Phone:</strong> <span class="editable" contenteditable="true">${phone}</span></li>
                </ul>
            </div>
        `;
        ...
        if (educationItems.length > 0) {
            ...
            educationItems.forEach(item => {
                ...
                resumeHTML += `
                    <li><strong><span class="editable" contenteditable="true">${degree}</span></strong> in 
                    <span class="editable" contenteditable="true">${school}</span> 
                    (<span class="editable" contenteditable="true">${year}</span>)</li>
                `;
            });
            resumeHTML += `</ul></div>`;
        }
        ...
        if (workItems.length > 0) {
            ...
            workItems.forEach(item => {
                ...
                resumeHTML += `
                    <li>
                        <strong><span class="editable" contenteditable="true">${position}</span></strong> 
                        at <span class="editable" contenteditable="true">${company}</span> 
                        (<span class="editable" contenteditable="true">${startDate}</span> - 
                        <span class="editable" contenteditable="true">${stillWorking ? "Present" : endDate}</span>)
                    </li>
                `;
            });
            resumeHTML += `</ul></div>`;
        ...
        if (skillItems.length > 0) {
            ...
            skillItems.forEach(item => {
                ...
                resumeHTML += `<li><span class="editable" contenteditable="true">${skill}</span></li>`;
            });
            resumeHTML += `</ul></div>`;
        }
