    ...
    function updateResume() {
        ...
        if (educationItems.length > 0) {
            ...
            educationItems.forEach(function (item) {
                ...
                resumeHTML += "<li><strong>".concat(degree, "</strong> in ").concat(school, " (").concat(year, ")</li>");
            });
            resumeHTML += "</ul></div>";
        }
        // Add Work Experience
        ...
        if (workItems.length > 0) {
            ...
            workItems.forEach(function (item) {
                ...
                resumeHTML += "<li><strong>".concat(position, "</strong> at ").concat(company, " (").concat(startDate, " - ").concat(stillWorking ? "Present" : endDate, ")</li>");
            });
            resumeHTML += "</ul></div>";
        }
        // Add Skills
